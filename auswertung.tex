...
\begin{tabular}{c c c c c c c c}
    \toprule
        Tröpfchen &$v_{\symup{auf}} \mathbin{/} 10^{-3}\unit{\m\per\s}$ & $v_{\symup{ab}}\mathbin{/} 10^{-3}\unit{\m\per\s}$ & $\bar{v}_{\symup{auf}} \mathbin{/} 10^{-3}\unit{\m\per\s}$& $\bar{v}_{\symup{ab}} \mathbin{/} 10^{-3}\unit{\m\per\s}$ & $\bar{v}_{\symup{ab}} -\bar{v}_{\symup{auf}} \mathbin{/} 10^{-3}\unit{\m\per\s}$ & $v_0 \mathbin{/}10^{-3}\unit{\m\per\s}$ & $2v_0 \mathbin{/}10^{-3}\unit{\m\per\s}$\\
    \midrule
    1&0.0695&0.1520&0.065&0.131&0.0661&0.0398&0.0796\\
    &0.0623&0.1370&&&&& \\
    &0.0632&0.1109&&&&& \\
...
4&0.3906&0.5000&0.3937&0.4251&0.0313&0.0069&0.0139\\
    &0.4505&0.3906&&&&& \\
    &0.3401&0.3846&&&&& \\
5&0.0929&0.2427&0.139&0.199&0.0602&0.0187&0.0373\\
    &0.2564&0.2155&&&&& \\
    &0.1429&0.1577&&&&& \\
...
\begin{tabular}{c c c c c c c c}
    ...
    11&0.2660&0.3311&0.1900&0.2350&0.0459&0.0054&0.0108 \\
              &0.0882&0.2747&&&&& \\
              &0.2128&0.0988&&&&& \\
    12&0.0967&0.0967&0.1002&0.106&0.0085&0.0047&0.0095 \\
              &0.0988&0.1082&&&&& \\
              &0.0963&0.1095&&&&& \\
    13&0.1004&0.1014&0.0978&0.1125&0.0147& -- & --\\
              &0.0863&0.1136&&&&& \\
               &0.1066&0.1225&&&&& \\
    14&0.0565&0.1099&0.587&0.104&0.0453&0.0228&0.0457 \\
              &0.0611&0.1012&&&&& \\
              &0.0588&0.1014&&&&& \\
...
\begin{tabular}{c c c }
    \toprule
        Tröpfchen & $q \mathbin{/} 10^{-19}\unit{\coulomb}$ &$q_{\symup{korr}} \mathbin{/} 10^{-19}\unit{\coulomb}$  \\
    \midrule
    1 & 7.2 \pm 0.40 & 5.9 \pm 0.40 \\
    5 & 11.8 \pm 0.70 & 9.6 \pm 0.60 \\
    12 & 2.2 \pm 0.13 & 1.3 \pm 0.09 \\
    14 & 4.0 \pm 0.24 & 3.2 \pm 0.20 \\
    16 & 1.61 \pm 0.10 & 1.1 \pm 0.07 \\
    \bottomrule
    \end{tabular}
    \label{tab:q}
\end{table}
...
\begin{align*}
    m &= (1.65 \pm 0.06) \cdot 10^{-19} \, \unit{\coulomb} \\
    b &= (-0.40 \pm 0.20) \cdot 10^{-19} \, \unit{\coulomb} \; . \\
\end{align*}
...
Der graphisch bestimmte Wert für die Elementarladung liegt bei $e_0=(1.65\pm 0.08)\cdot 10^{-19}\,\unit{\coulomb}$ und entspricht somit nicht ganz dem theoretischen Wert ($e_{0,\text{theo}}=1.602\cdot 10^{-19}\,\unit{\coulomb}$ \cite{e}), 
...
\begin{equation*}
    N_{\text{A}}=\frac{F}{e_0} 
\end{equation*}
wobei F die Faraday-Konstante mit einem Wert $9.648\cdot 10^4\, \unit{\frac{\coulomb}{\mol}}$\cite{Fara} ist, bestimmt.
Aus der oben bestimmten Ladung folgt so die Avogadro-Konstante
\begin{equation*}
    N_{\text{A,exp}}= (5.85\pm 0.21) \cdot 10^{23}\, \unit{\mol}^{-1} \; .
\end{equation*}
