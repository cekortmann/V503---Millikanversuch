...
r5=  radius2(eta220, vab5, vauf5)
r12= radius2(eta220, vab12, vauf12)
r14 = radius2(eta220, vab14, vauf14)
r16 = radius2(eta220, vab16, vauf16)
...
#print('Radius 5. Tröpfchen',radius2(eta220, vab5, vauf5))
#print('Radius 12. Tröpfchen',radius2(eta220, vab12, vauf12))
#print('Radius 14. Tröpfchen',radius2(eta220, vab14, vauf14))
#print('Radius 16. Tröpfchen',radius2(eta220, vab16, vauf16))
...
print(qkorr(q(eta205, vab12, vauf12, 250, du),r12))
...
print(q(eta205, vab12, vauf12, 250, du))
